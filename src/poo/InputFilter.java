...
public class InputFilter {
	...
	/*
	 * metodo onde será trabalhado o input para o caso de existir o operador Filter nele
	 * @param tempArr arrayList onde será acrescentado os elementos relevantes do input
	 * @param arr array de Strings que contém parate do input
	 * @param lastElement integer que indica qual a posição do ultimo elemento do array arr
	...
	/*
	 * metodo onde será trabalhado o input para o caso de existir o operador Calculate nele
	 * @param tempArr arrayList onde será acrescentado os elementos relevantes do input
	 * @param arr array de Strings que contém parate do input
	 * @param lastElement integer que indica qual a posição do ultimo elemento do array arr
	 * @return tempArr arrayList introduzido nos argumentos de entrada
