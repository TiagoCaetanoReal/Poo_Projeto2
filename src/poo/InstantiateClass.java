...
public class InstantiateClass {
	 ...
	 * 
	 * @param dictionary map onde estam listadas todas as colunas do csv e é dito
	 * qual o tipo primitivo usado nela
	 */
	public InstantiateClass(ArrayList<HashMap<String, String>> table, String[] filteredQuery,
	 ...
	 * getter e setters
	 */
	String[] getFilteredQuery() {
		return this.filteredQuery;
	}

	private void serFilteredQuery(String[] filteredQuery) {
		this.filteredQuery = filteredQuery;
	}
	...
	private void setTable(ArrayList<HashMap<String, String>> table) {
		this.table = table;
	}
	...
	private void setDictionary(HashMap<String, String> dictionary) {
		this.dictionary = dictionary;
	}

	/*
	 * metodo usado para instanciar a classe da primeira opcao de filtragem ou
	 * agregaçao usada
	 */
	void determineClass() {
		String[] filteration;
		...
		if (getFilteredQuery()[0].equalsIgnoreCase("Filter")) {
			...
			Calculate calculate = new Calculate(filterAndAgregate[0], filterAndAgregate[1], getTable(),
					getDictionary());
	...
	/*
	 * metodo para executar um novo polimento no input, porém desta vez, moldando-o
	 * para a classe Calculate
	 * 
	 * @return filterAndAgregate que é um array com duas posiçoes primeira para a
	 * string da agregacao e a segunda para a filtragem
	 */
	...
	/*
	 * metodo para executar um novo polimento no input, porém desta vez, moldando-o
	 * para a classe Filter
	 * 
	 * @return filteration que é um array onde sera colocado todos os elementos de
	 * filteredQuery menos o conteudo indesejado
	 */
